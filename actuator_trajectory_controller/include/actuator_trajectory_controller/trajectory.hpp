...
#ifndef ACTUATOR_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_
#define ACTUATOR_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_
...
public:
  ...
  ACTUATOR_TRAJECTORY_CONTROLLER_PUBLIC
  explicit Trajectory(std::shared_ptr<trajectory_msgs::msg::JointTrajectory> actuator_trajectory);

  ACTUATOR_TRAJECTORY_CONTROLLER_PUBLIC
  explicit Trajectory(
    const rclcpp::Time & current_time,
    const trajectory_msgs::msg::JointTrajectoryPoint & current_point,
    std::shared_ptr<trajectory_msgs::msg::JointTrajectory> actuator_trajectory);
  ...
  ACTUATOR_TRAJECTORY_CONTROLLER_PUBLIC
  void update(std::shared_ptr<trajectory_msgs::msg::JointTrajectory> actuator_trajectory);
...
#endif  // ACTUATOR_TRAJECTORY_CONTROLLER__TRAJECTORY_HPP_
