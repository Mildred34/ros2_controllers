...
#ifndef ACTUATOR_TRAJECTORY_CONTROLLER__ACTUATOR_TRAJECTORY_CONTROLLER_HPP_
#define ACTUATOR_TRAJECTORY_CONTROLLER__ACTUATOR_TRAJECTORY_CONTROLLER_HPP_
...
#include "actuator_trajectory_controller/interpolation_methods.hpp"
#include "actuator_trajectory_controller/tolerances.hpp"


#include "actuator_trajectory_controller/visibility_control.h"
...
class ActuatorTrajectoryController : public controller_interface::ControllerInterface
{
public:
  ACTUATOR_TRAJECTORY_CONTROLLER_PUBLIC
  ActuatorTrajectoryController();
...
protected:
  ...
  // same msg type (test)
  ActuatorTrajectoryPoint state_current_;
  ActuatorTrajectoryPoint state_desired_;
  ActuatorTrajectoryPoint state_error_;

  // Degrees of freedom
  size_t dof_;

  // Storing command joint names for interfaces
  std::vector<std::string> command_actuator_names_;

  // Parameters from ROS for joint_trajectory_controller
  std::shared_ptr<ParamListener> param_listener_;
  Params params_;

  ActuatorTrajectoryPoint last_commanded_state_;
  ...
  InterfaceReferences<hardware_interface::LoanedCommandInterface> actuator_command_interface_;
  InterfaceReferences<hardware_interface::LoanedStateInterface> actuator_state_interface_;
  ...
  rclcpp::Subscription<trajectory_msgs::msg::JointTrajectory>::SharedPtr actuator_command_subscriber_ =
    nullptr;
  ...
  // sorts the actuators of the incoming message to our local order
  ACTUATOR_TRAJECTORY_CONTROLLER_PUBLIC
  void sort_to_local_actuator_order(
  ...
  void read_state_from_hardware(ActuatorTrajectoryPoint & state);

  bool read_state_from_command_interfaces(ActuatorTrajectoryPoint & state);

private:
  bool contains_interface_type(
    const std::vector<std::string> & interface_type_list, const std::string & interface_type);

  void resize_actuator_trajectory_point(
    ActuatorTrajectoryPoint & point, size_t size);
};

}  // namespace actuator_trajectory_controller

#endif  // ACTUATOR_TRAJECTORY_CONTROLLER__ACTUATOR_TRAJECTORY_CONTROLLER_HPP_
