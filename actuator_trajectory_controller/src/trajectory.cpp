...
Trajectory::Trajectory(std::shared_ptr<trajectory_msgs::msg::JointTrajectory> actuator_trajectory)
: trajectory_msg_(actuator_trajectory),
  trajectory_start_time_(static_cast<rclcpp::Time>(actuator_trajectory->header.stamp))
{
}
...
void Trajectory::update(std::shared_ptr<trajectory_msgs::msg::JointTrajectory> actuator_trajectory)
{
  trajectory_msg_ = actuator_trajectory;
  trajectory_start_time_ = static_cast<rclcpp::Time>(actuator_trajectory->header.stamp);
